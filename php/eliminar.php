...
$id=$_POST['id'];
$con= new Conexion();
  $query= $con->prepare("SELECT nombre,idproductos FROM productos WHERE idproductos='$id'
    ");
...
foreach ($resultado as $res) {
	...
	<form  action='return false' onsubmit='return false' enctype='multipart/form-data'>
        ...
        <div class='row'>
          <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
                        <input type='submit' id='elimina' class='btn btn-lg btn-success btn-block' value='Eliminar'>
          </div>
 ...
 ?>
 <script type="text/javascript" src="js/eliminarcupon.js"></script>