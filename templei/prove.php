    ...
    <div id="resultado"></div>
        ...
        <div class="form-group">
				<div class="form-group col-lg-12">
                    <input type="text" name="usuario" id="usuario" class="form-control input-lg" placeholder="Nombre Completo" required><label  id ="mensaje1">Completar campo</label>
				</div>
                <br>
        ...
        <select id="provincia" name="provincia"  class="form-control input-lg  dropdown-toggle" type="button" data-toggle="dropdown" required>Provincias
                ...
                <div class="form-group col-lg-6">
                  ...
                  <select id="ciudad" name="ciudad" class="form-control input-lg dropdown-toggle" type="button" data-toggle="dropdown" required>Localidades<span class="caret"></span>
                     ...
                     <br>
                     <div class="form-group col-lg-6">
                    <input type="text" name="direc" id="direc" class="form-control input-lg" pattern=".{4,30}" title="direccion  invalida" placeholder="direccion" required><label  id ="mensaje3">Completar campo</label>
        </div>
                   
                     <br>
        <div class="form-group col-lg-6">
                    <input type="password" name="contra" id="contra" class="form-control input-lg" placeholder="Contraseña" required><label  id ="mensaje4">Completar campo</label>
        </div>
