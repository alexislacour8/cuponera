...
<?php 
	...
	$nume=$_GET["nume"];
	$con= new Conexion();
	$query= $con->prepare("SELECT  cuponventa.fecha as fechas,idcuponventa,nombre,canti,imagen,monto,codgio,codigoventa FROM productos,cuponventa WHERE usuario_idusuario ='$nume' and idproductos = productos_idproductos and estadoven=0");
...
<div class="container">
  ...
  <br>
  <br>
  <center><h2>Control de ventas de cupones</h2></center>
    <div class="row">
                ...
                <table class="table table-striped table-bordered table-list">
                  <thead>
                     <tr class="filters">
                        ...
                        <th  style="width: 150px;"><input type="text" class="form-control" placeholder="Nombre completo" disabled ></th>
                        <th><input type="text" class="form-control" placeholder="cantidad" disabled></th>
                         <th><input type="text" class="form-control" placeholder="Precio" disabled></th>
                          <th><input type="text" class="form-control" placeholder="Codigo producto" disabled></th>
                           <th><input type="text" class="form-control" placeholder="Codigo venta" disabled></th>
